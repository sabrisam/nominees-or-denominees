...
export function WinnersTab({
  ...
  return (
    <motion.section
      ...
      className="space-y-2"
    >
      <BrutalCard tone="black" className="p-3 text-white bg-monolith border-champagne/20">
        <p className="mb-1 text-[8px] font-black uppercase tracking-[0.2em] text-champagne font-sans">Cérémonie</p>
        <h2 className="tabloid-headline text-[clamp(1.55rem,7.8vw,2.7rem)] leading-[0.84] od-display">TROPHÉES</h2>
      </BrutalCard>

      {ultimateWinner && (
        <BrutalCard tone="yellow" className="p-3 bg-monolith border-champagne/40">
      ...
      {paparazziOr && (
        <BrutalCard className="p-3 bg-monolith border-champagne/20">
      ...
      <BrutalCard tone="black" className="p-2.5 bg-monolith border-champagne/20">
        <p className="text-[8px] font-black uppercase tracking-[0.2em] text-champagne font-sans">Course aux trophées</p>

                  ...
                  {creatorNominations.map((n) => {
                    ...
                    return (
                      <div
                        ...
                        className={`flex items-center gap-3 px-2.5 py-1.5 rounded-[4px] border border-white/5 bg-void ${
                          onNominationClick ? "cursor-pointer hover:border-[#d4af37]/40 transition-all duration-200" : ""
                        }`}
                      >

            ...
            <div className="grid grid-cols-6 gap-0.5">
              {[0, 1, 2, 3, 4, 5].map((score) => (
                <motion.button
                  ...
                  className={`h-4 rounded-[7px] border text-[8px] font-black leading-none transition ${activeScore === score ? "border-champagne/80 bg-champagne/20 text-champagneSoft" : "border-white/10 bg-white/[0.035] text-zinc-500"}`}
